...
const translations: Record<Language, Record<string, any>> = {
  en: {
    ...
    'filters': { 'all': 'All', 'policy': 'Policy', 'contract': 'Contract', 'form': 'Form', 'other': 'Other' },
    'table': { 'name': 'Name', 'category': 'Category', 'date': 'Date', 'size': 'Size', 'actions': 'Actions' },
    // Payslips
    ...
    // Help & FAQ
    'help_faq': 'Help & FAQ',
    'help_sub': 'Find answers to common questions and learn how to use the portal.',
    ...
    'contact_support_desc': 'If you cannot find the answer you are looking for, please contact our support team.',
    'contact_support': 'Contact Support',
    'faq_q1': 'How do I reset my password?',
    'faq_a1': 'To reset your password, please contact the IT department or use the "Forgot Password" link on the login page if available.',
    'faq_q2': 'Where can I find my employment contract?',
    'faq_a2': 'You can find your employment contract and other HR documents in the "Documents Center" under the "Contract" filter.',
    'faq_q3': 'How do I connect to the company VPN?',
    'faq_a3': 'Please submit an IT Support ticket requesting VPN access. Once approved, you will receive an email with instructions and credentials.',
    'faq_q4': 'What is the deadline for ordering food?',
    'faq_a4': 'Food orders for the upcoming week must be submitted by Wednesday at 2:00 PM.',
    'faq_q5': 'How do I request annual leave?',
    'faq_a5': 'Annual leave requests should be submitted through the Rahkaran system. You can view your approved leaves in the Company Calendar.',
    // ERP
  ...
  fa: {
    ...
    'filters': { 'all': 'همه', 'policy': 'بخشنامه', 'contract': 'قرارداد', 'form': 'فرم', 'other': 'سایر' },
    'table': { 'name': 'نام فایل', 'category': 'دسته‌بندی', 'date': 'تاریخ', 'size': 'حجم', 'actions': 'عملیات' },
    // Payslips
    ...
    'surveys_sub': 'با به اشتراک گذاشتن نظرات خود به ما در بهبود پرشیا خودرو کمک کنید.',
    ...
    'help_sub': 'پاسخ سوالات رایج را بیابید و نحوه استفاده از پورتال را بیاموزید.',
    ...
    'contact_support_desc': 'اگر پاسخ سوال خود را پیدا نکردید، لطفاً با تیم پشتیبانی ما تماس بگیرید.',
    'contact_support': 'تماس با پشتیبانی',
    'faq_q1': 'چگونه رمز عبور خود را تغییر دهم؟',
    'faq_a1': 'برای تغییر رمز عبور، لطفاً با بخش IT تماس بگیرید یا در صورت وجود از لینک "فراموشی رمز عبور" در صفحه ورود استفاده کنید.',
    'faq_q2': 'قرارداد استخدامی خود را کجا می‌توانم پیدا کنم؟',
    'faq_a2': 'شما می‌توانید قرارداد استخدامی و سایر مدارک منابع انسانی خود را در "مرکز اسناد" تحت فیلتر "قرارداد" پیدا کنید.',
    'faq_q3': 'چگونه به VPN شرکت متصل شوم؟',
    'faq_a3': 'لطفاً یک تیکت پشتیبانی IT برای درخواست دسترسی به VPN ثبت کنید. پس از تایید، ایمیلی حاوی دستورالعمل‌ها و اطلاعات ورود دریافت خواهید کرد.',
    ...
    'faq_a5': 'درخواست‌های مرخصی سالانه باید از طریق سیستم راهکاران ثبت شوند. می‌توانید مرخصی‌های تایید شده خود را در تقویم سازمانی مشاهده کنید.',
    // ERP
